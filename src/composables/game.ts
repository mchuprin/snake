import { DirectionRuleI } from '@/interfaces/direction-rule.interface'
...
export function useGame () {
  ...
  const changeDirection = (newDirection: number) => {
    ...
    const actualRule: DirectionRuleI | undefined = directionsRules.find(dir => dir.direction === direction.value)
